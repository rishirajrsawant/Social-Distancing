...
//        Imgproc.cvtColor(mFGMask, tempMat, Imgproc.COLOR_GRAY2RGBA);

        hogDescriptor.detectMultiScale(frame, foundLocations, foundWeights, 0, new Size(4,4),
                new Size(8, 8), 1.05);

                    Log.i("area798", "a:"+foundLocations);
...
//        {
//
//            hogDescriptor.detectMultiScale(frame, foundLocations, foundWeights, 1.5, new Size(4,4),
//                   new Size(8, 8), 1.05);
